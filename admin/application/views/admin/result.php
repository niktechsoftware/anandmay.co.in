			                                   ...
			                                   <form class="form-horizontal" action="<?php echo base_url()?>apanelForms/editResult" method="post">
			                                        <div class="form-group">
			                                            ...
			                                            <div class="col-sm-4">
			                                                ...
			                                                <input type="text" class="form-control" value="<?php echo $deta->fun_title; ?>" id="input-Default" name="fun_title" autocomplete="off">
			                                             </div>
			                                             <label for="input-Default" class="col-sm-2 control-label"><strong>Wonder Result</strong></label>
			                                            <div class="col-sm-4">
			                                               <input type="text" class="form-control" value="<?php echo $deta->wonder_title; ?>" id="input-Default" name="wonder_title" autocomplete="off">
			                                            </div>
			                                        ...
			                                        <div class="form-group">
			                                            ...
			                                            <div class="col-sm-4">
			                                               <input type="text" class="form-control" value="<?php echo $deta->lucky_title; ?>" id="input-Default" name="lucky_title" autocomplete="off">
			                                            </div>
			                                	...
			                                	<form class="form-horizontal" action="<?php echo base_url()?>quiz/quizResult" method="post">
			                                	   ...
			                                	   <div class="form-group">
			                                        ...
			                                        <div class="form-group">
			                                            ...
			                                            <div class="col-sm-2">
			                                                <input type="text" class="form-control" id="input-Default" name="fun_title" autocomplete="off" required>
			                                            </div>
			                                      
			                                        
			                                            <label for="input-Default" class="col-sm-2 control-label"><strong>Fun Quiz Detail</strong></label>
			                                            <div class="col-sm-6">
			                                                <input type="text" class="form-control" id="input-Default123" name="fun_detail" autocomplete="off" required>
			                                            </div>
			                                        </div>
			                                        <div class="form-group">
			                                            <label for="input-Default" class="col-sm-2 control-label"><strong>Wonder Quiz Title</strong></label>
			                                            <div class="col-sm-2">
			                                                <input type="text" class="form-control" id="input-Default" name="wonder_title" autocomplete="off" required>
			                                            </div>
			                                      
			                                        
			                                            <label for="input-Default" class="col-sm-2 control-label"><strong>Wonder Quiz Detail</strong></label>
			                                            <div class="col-sm-6">
			                                                <input type="text" class="form-control" id="input-Default123" name="wonder_detail" autocomplete="off" required>
			                                            </div>
			                                        </div>
			                                         <div class="form-group">
			                                            <label for="input-Default" class="col-sm-2 control-label"><strong>Lucky Quiz Title</strong></label>
			                                            <div class="col-sm-2">
			                                                <input type="text" class="form-control" id="input-Default" name="lucky_title" autocomplete="off" required>
			                                            </div>
			                                      
			                                        
			                                            <label for="input-Default" class="col-sm-2 control-label"><strong>Lucky Quiz Detail</strong></label>
			                                            <div class="col-sm-6">
			                                                <input type="text" class="form-control" id="input-Default123" name="lucky_detail" autocomplete="off" required>
			                                            </div>
			                                        </div>
			                                         <div class="col-sm-offset-2 col-sm-10">
